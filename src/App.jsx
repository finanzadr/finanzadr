...
const WS_STOCKS = [
  ...
  { titulo: "S&P 500 cierra en m�ximo hist�rico mientras mercados celebran pausa de la Fed", resumen: "El S&P 500 alcanz� un nuevo r�cord cerrando por encima de 5,800 puntos este viernes, impulsado por datos de empleo m�s fuertes de lo esperado. La Reserva Federal se�al� que mantendr�a las tasas sin cambios hasta tener mayor claridad sobre la inflaci�n.", fuente: "Reuters", tiempo: "Hace 1 hora", categoria: "Mercados" },
  { titulo: "NVIDIA supera los $1,000 por acci�n por primera vez en su historia", resumen: "Las acciones de NVIDIA cruzaron la barrera de los $1,000 por primera vez impulsadas por una demanda r�cord de chips para inteligencia artificial. La compa��a report� ingresos trimestrales de $44 mil millones, un 78% m�s que el a�o anterior.", fuente: "Bloomberg", tiempo: "Hace 3 horas", categoria: "Acciones" },
  { titulo: "El oro alcanza nuevos m�ximos hist�ricos ante la incertidumbre geopol�tica global", resumen: "El precio del oro super� los $3,400 por onza este mes, estableciendo un nuevo r�cord hist�rico. Los inversores buscan refugio en metales preciosos ante las tensiones geopol�ticas y el debilitamiento del d�lar.", fuente: "WSJ", tiempo: "Hace 5 horas", categoria: "Materias Primas" },
  { titulo: "Bitcoin consolida por encima de los $90,000 con creciente adopci�n institucional", resumen: "Bitcoin mantiene su posici�n por encima de los $90,000 respaldado por compras institucionales y la aprobaci�n de nuevos ETFs en mercados europeos y asi�ticos.", fuente: "CNBC", tiempo: "Hace 7 horas", categoria: "Cripto" },
  { titulo: "Los bonos del Tesoro a 10 a�os suben ante se�ales de desaceleraci�n econ�mica", resumen: "El rendimiento del bono del Tesoro a 10 a�os cay� al 4.2% mientras los inversores buscan activos m�s seguros. Los datos de manufactura mostraron una contracci�n por segundo mes consecutivo.", fuente: "Financial Times", tiempo: "Hace 9 horas", categoria: "Bonos" },
  { titulo: "Dow Jones supera los 42,000 puntos impulsado por sector financiero y salud", resumen: "El Dow Jones Industrial Average super� los 42,000 puntos esta semana, liderado por fuertes ganancias en el sector financiero y de salud.", fuente: "MarketWatch", tiempo: "Hace 11 horas", categoria: "Mercados" },
];const GUIAS = [
  { titulo: "C�mo abrir tu primera cuenta de inversi�n desde Latinoam�rica", extracto: "Gu�a paso a paso para abrir una cuenta en Fidelity o Interactive Brokers desde cualquier pa�s de Am�rica Latina.", contenido: "Invertir en Wall Street desde Latinoam�rica es m�s f�cil de lo que piensas.\n\nPASO 1: ELIGE TU PLATAFORMA\nPara principiantes recomendamos Fidelity o Interactive Brokers. Ambas aceptan clientes internacionales y no cobran comisiones.\n\nPASO 2: DOCUMENTOS NECESARIOS\nNecesitas tu pasaporte vigente, comprobante de domicilio y un n�mero de tel�fono. Todo el proceso es 100% online.\n\nPASO 3: ABRE LA CUENTA\nEntra a fidelity.com o interactivebrokers.com, selecciona Open an Account y elige Individual Brokerage Account.\n\nPASO 4: DEPOSITA TU PRIMER DINERO\nPuedes depositar desde $1 d�lar usando transferencia bancaria o servicios como Wise o Remitly.\n\nPASO 5: COMPRA TU PRIMER ETF\nPara empezar, compra VOO (Vanguard S&P 500 ETF). Con un solo producto tienes exposici�n a las 500 empresas m�s grandes de EE.UU.", autor: "Equipo FinanzaDR", fecha: "Mayo 2026", tags: ["principiantes", "brokers", "ETF"] },
  { titulo: "�Qu� es el S&P 500 y por qu� es la mejor inversi�n para principiantes?", extracto: "El S&P 500 ha generado un retorno promedio del 10% anual durante los �ltimos 50 a�os.", contenido: "El S&P 500 es el �ndice burs�til m�s importante del mundo. Incluye las 500 empresas m�s grandes de Estados Unidos.\n\nEn los �ltimos 50 a�os, el S&P 500 ha generado un retorno promedio del 10% anual.\n\nLos ETFs m�s populares son:\n- VOO (Vanguard): costo de solo 0.03% anual\n- SPY (SPDR): el m�s antiguo y l�quido\n- IVV (iShares): otra excelente opci�n\n\nLA ESTRATEGIA GANADORA: DCA\nInvertir una cantidad fija cada mes sin importar si el mercado sube o baja.", autor: "Equipo FinanzaDR", fecha: "Mayo 2026", tags: ["S&P 500", "ETF", "estrategia"] },
  { titulo: "Los 5 errores m�s comunes al invertir por primera vez", extracto: "El 80% de los inversores principiantes cometen estos errores.", contenido: "ERROR 1: ESPERAR EL MOMENTO PERFECTO\nNo existe el momento perfecto. El tiempo en el mercado siempre supera al timing.\n\nERROR 2: PONER TODO EN UNA SOLA ACCI�N\nLos ETFs como el S&P 500 te dan diversificaci�n autom�tica.\n\nERROR 3: VENDER CUANDO EL MERCADO CAE\nEl mercado siempre ha subido a largo plazo.\n\nERROR 4: INVERTIR DINERO QUE PUEDES NECESITAR\nSolo invierte dinero que no vas a necesitar en los pr�ximos 5 a�os.\n\nERROR 5: NO EMPEZAR POR MIEDO\nEl dinero que no inviertes pierde valor cada a�o por la inflaci�n.", autor: "Equipo FinanzaDR", fecha: "Mayo 2026", tags: ["errores", "principiantes", "estrategia"] },
];

const CONSEJOS = [
  { icono: "??", nivel: "Principiante", consejo: "Empieza con ETFs, no acciones individuales", detalle: "Un ETF del S&P 500 te da exposici�n a 500 empresas con una sola compra." },
  ...
  { icono: "?", nivel: "Principiante", consejo: "Piensa en a�os, no en d�as", detalle: "Los inversores exitosos mantienen su estrategia por a�os." },
  { icono: "??", nivel: "Principiante", consejo: "Abre una cuenta en Fidelity o Interactive Brokers", detalle: "Ambas plataformas aceptan clientes de Latinoam�rica sin comisiones." },
];
...
let C = { ...DARK };export default function FinanzasDR() {
  ...
  const fetchNoticias = async () => {
    ...
    try {
      ...
      if (data && data.length > 0) {
        const cats = { "earnings":"Ganancias","ipo":"IPO","merger":"Fusiones","crypto":"Cripto","forex":"Divisas","economy":"Econom�a","general":"Mercados" };
        setNoticias(data.slice(0,10).map(n => ({ titulo: n.headline, resumen: n.summary?.slice(0,240)+"..." || "Sin resumen.", fuente: n.source||"Finnhub", tiempo: (() => { const m=Math.floor((Date.now()/1000-n.datetime)/60); return m<60?`Hace ${m} min`:m<1440?`Hace ${Math.floor(m/60)}h`:`Hace ${Math.floor(m/1440)} d�as`; })(), categoria: cats[n.category]||"Mercados", url: n.url })));
      }
    } catch(e) {}
  ...
  const tabs = [
    ["inicio","?? Empieza Aqu�"],["mercados","?? Mercados"],["charts","?? Charts en Vivo"],
  ...
  return (
    <div style={{ minHeight:"100vh", width:"100vw", maxWidth:"100%", background:C.bg, color:C.text, fontFamily:"'Inter',sans-serif", overflowX:"hidden" }}>
      ...
      <main style={{ padding:"32px", maxWidth:"100%", margin:"0 auto" }} className="main-padding">{tab === "inicio" && (
          <div className="fade-in">
            <div style={{ background:dark?"linear-gradient(135deg,#07080f 0%,#0d0f1e 40%,#0f1228 100%)":"linear-gradient(135deg,#eef0f8 0%,#e8eaf5 100%)", border:`1px solid ${C.gold}25`, borderRadius:20, padding:"48px 40px 40px", marginBottom:24, borderTop:`3px solid ${C.gold}` }}>
              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:32 }} className="hero-grid">
                <div style={{ maxWidth:540 }} className="hero-text">
                  ...
                  <p style={{ fontSize:15, color:C.sub, lineHeight:1.8, marginBottom:28, maxWidth:460 }}>Precios en tiempo real, charts profesionales y educaci�n financiera para latinos que quieren invertir en Wall Street.</p>
                  ...
                  <div style={{ display:"flex", gap:24, marginTop:28, paddingTop:24, borderTop:`1px solid ${C.border}`, flexWrap:"wrap" }}>
                    {[{n:"8",l:"Activos en Vivo"},{n:"8",l:"Charts Disponibles"},{n:"24/7",l:"Datos en Tiempo Real"},{n:"$0",l:"Costo Total"}].map((s,i) => (
                      <div key={i}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))", gap:16, marginBottom:28 }} className="summary-grid">
              ...
              <div style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:12, padding:"20px 22px" }}>
                <Label style={{ margin:"0 0 12px 0" }}>-- ACCESO R�PIDO</Label>
            ...
            <SectionTitle>�D�nde abrir tu cuenta?</SectionTitle>
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(180px,1fr))", gap:12, marginTop:16, marginBottom:28 }}>
              {[{name:"Robinhood",emoji:"??",nivel:"Principiante",detalle:"Sin comisiones, muy f�cil de usar."},{name:"Webull",emoji:"??",nivel:"Principiante",detalle:"Sin comisiones, m�s herramientas."},{name:"Moomoo",emoji:"??",nivel:"Intermedio",detalle:"Datos en tiempo real profesionales."},{name:"Tastytrade",emoji:"??",nivel:"Intermedio",detalle:"Especializado en opciones y futuros."},{name:"Interactive Brokers",emoji:"??",nivel:"Avanzado",detalle:"Acepta clientes de RD y Latinoam�rica."}].map((b,i) => (
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))", gap:14, marginTop:16 }}>
              {[{n:"01",t:"Elige una plataforma",d:"Robinhood o Webull si eres principiante. Interactive Brokers si vives fuera de EE.UU."},{n:"02",t:"Abre tu cuenta",d:"Necesitas pasaporte, direcci�n y un m�todo de pago. 100% online."},{n:"03",t:"Empieza con ETFs",d:"El S&P 500 (VOO o SPY) es el mejor inicio. 500 empresas, un solo producto."},{n:"04",t:"Invierte consistente",d:"$50/mes durante 20 a�os supera $10,000 de golpe."}].map((s,i) => (
          ...
          <div className="fade-in">
            ...
            <div style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:12, padding:"24px 28px" }}>
              <Label>-- �Qu� es cada activo?</Label>
              <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))", gap:16 }}>
                {[{s:"SPY",d:"ETF que replica el S&P 500 � las 500 empresas m�s grandes de EE.UU."},{s:"QQQ",d:"ETF del NASDAQ 100 � dominado por tecnolog�a."},{s:"DIA",d:"ETF del Dow Jones � las 30 empresas m�s importantes de EE.UU."},{s:"IWM",d:"ETF del Russell 2000 � 2,000 empresas peque�as de EE.UU."},{s:"TLT",d:"ETF de bonos del Tesoro a 20+ a�os."},{s:"XLU",d:"ETF del sector Utilities � estable en mercados vol�tiles."},{s:"GLD",d:"ETF del oro � activo refugio por excelencia."},{s:"BTC-USD",d:"Bitcoin � la criptomoneda m�s importante del mundo."}].map((x,i) => (
        ...
        {tab === "blog" && (
          <div className="fade-in">
            ...
            <p style={{ fontSize:13, color:C.sub, marginTop:4, marginBottom:24 }}>Gu�as completas para inversores principiantes e intermedios</p>
              ...
              {GUIAS.map((post,i) => (
                <div key={i} style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:8, padding:"26px 30px" }}>
                  ...
                  <button onClick={() => setExpanded(expanded===i?null:i)} style={{ marginTop:18, background:"none", border:`1px solid ${C.gold}`, color:C.gold, padding:"9px 22px", borderRadius:5, cursor:"pointer", fontFamily:"'IBM Plex Mono'", fontSize:12, fontWeight:600 }}>
                    {expanded===i?"? Ver menos":"Leer gu�a completa ?"}
                  </button>
                </div>
              ))}
            </div>
        ...
        {tab === "charts" && (
          <div className="fade-in">
            ...
            <p style={{ fontSize:13, color:C.sub, marginTop:4, marginBottom:24 }}>Gr�ficas en tiempo real powered by TradingView</p>
            <TradingViewCharts />
          </div>
        )}
        {tab === "snapshot" && (
        ...
        {tab === "newsletter" && (
          <div className="fade-in">
            <div style={{ background:dark?"linear-gradient(135deg,#0f1228,#130f2a)":"linear-gradient(135deg,#eef0f8,#e8eaf5)", border:`1px solid ${C.gold}30`, borderRadius:16, padding:"40px", marginBottom:32, textAlign:"center" }}>
              ...
              <h1 style={{ fontFamily:"'Playfair Display',serif", fontSize:32, fontWeight:800, color:C.text, marginBottom:14, lineHeight:1.3 }}>Lo m�s importante de<br/><span style={{ color:C.gold }}>Wall Street en tu idioma</span></h1>
              <p style={{ fontSize:15, color:C.sub, maxWidth:480, margin:"0 auto 32px", lineHeight:1.8 }}>Cada semana te enviamos un resumen claro de lo que pas� en los mercados.</p>
      ...
      <footer style={{ borderTop:`1px solid ${C.border}`, padding:"20px 32px", textAlign:"center", fontFamily:"'IBM Plex Mono'", fontSize:11, color:C.muted, marginTop:40 }}>
        FinanzaDR � 2026 � Educaci�n financiera para latinos � No constituye asesor�a de inversi�n
      </footer>
    </div>
  );
...
function NewsletterForm() {
  ...
  if (status === "success") return (
    <div style={{ background:"#00d68f15", border:"1px solid #00d68f", borderRadius:12, padding:"28px 24px", textAlign:"center" }}>
      ...
      <div style={{ fontFamily:"'Playfair Display',serif", fontSize:22, fontWeight:700, color:"#00d68f", marginBottom:8 }}>�Ya est�s suscrito!</div>
  ...
  return (
    <div>
      ...
      {status==="error" && <p style={{ fontSize:12, color:C.red }}>?? Ingresa un email v�lido</p>}
    </div>
  );
}
...
function CompoundCalc() {
  ...
  return (
    <div>
      <SectionTitle>Calculadora de Inversi�n</SectionTitle>
      <p style={{fontSize:13,color:C.sub,marginTop:4,marginBottom:20}}>El S&P 500 ha retornado ~10% anual hist�ricamente.</p>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:24,alignItems:"start"}} className="calc-grid">
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:12,padding:"24px"}}>
          <div style={{marginBottom:18}}><label style={labelStyle}>Inversi�n Inicial ({sym})</label>{numInput(capital,setCapital,1000)}</div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:18}}>
            ...
            <div><label style={labelStyle}>Capitalizaci�n</label><select value={capitaliz} onChange={e=>setCapitaliz(e.target.value)} style={selStyle}>{["Anual","Mensual","Trimestral","Semestral"].map(o=><option key={o}>{o}</option>)}</select></div>
          </div>
          <div style={{marginBottom:18}}><label style={labelStyle}>A�os de Crecimiento</label>{numInput(anos,setAnos,1,1)}</div>
        </div>
        ...
        <div style={{width:"100%",height:300}}>
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={filas} margin={{top:10,right:30,left:10,bottom:0}}>
              ...
              <Tooltip contentStyle={{background:C.card,border:`1px solid ${C.border}`,borderRadius:8,fontFamily:"'IBM Plex Mono'",fontSize:12}} labelFormatter={v=>`A�o ${v}`} formatter={(v,n)=>["$"+Math.round(v).toLocaleString(),n==="aporteAcum"?"Capital Base":n==="interesAcum"?"Ganancias Acum.":n==="ganancia"?"Ganancia A�o":n]}/>
              ...
              <Line type="monotone" dataKey="ganancia" stroke={C.gold} strokeWidth={2.5} dot={{fill:C.gold,r:3}} name="Ganancia A�o"/>
            </ComposedChart>
          </ResponsiveContainer>
        </div>
      </div>
      ...
      <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:12,padding:"20px 24px",overflowX:"auto"}}>
        <table style={{width:"100%",borderCollapse:"collapse",fontFamily:"'IBM Plex Mono'",fontSize:12,minWidth:700}}>
          <thead><tr style={{background:C.card,borderBottom:`1px solid ${C.border}`}}>{[vistaTabla==="Mensual"?"Mes":"A�o","Capital Base","Aporte","Capital Total","Ganancia","% Ganancia","Ganancia Acum.","Valor Final"].map((h,i)=>(<th key={i} style={{padding:"10px 12px",fontWeight:500,textAlign:i===0?"left":"right",color:C.muted,whiteSpace:"nowrap"}}>{h}</th>))}</tr></thead>
          <tbody>
            {vistaTabla==="Anual"?filas.map((f,i)=>(<tr key={i} style={{borderBottom:`1px solid ${C.border}20`,background:i%2===0?"transparent":"#ffffff03"}}>
              <td style={{padding:"10px 12px",color:C.gold}}>A�o {f.ano}</td>
  ...
  return (
    <div>
      <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:12,padding:"28px 32px",marginBottom:24,textAlign:"center"}}>
        ...
        <p style={{fontSize:13,color:C.sub,marginBottom:24}}>Escribe el s�mbolo del activo � AAPL, BTC, GLD, EUR/USD.</p>
      ...
      {activeSymbol ? (
        ...
        <div style={{textAlign:"center",padding:"60px 32px",background:C.card,border:`1px dashed ${C.border}`,borderRadius:12}}>
          <div style={{fontSize:48,marginBottom:16}}>??</div>
          <p style={{fontFamily:"'IBM Plex Mono'",fontSize:13,color:C.muted,lineHeight:1.8}}>Escribe el s�mbolo arriba y presiona <strong style={{color:C.gold}}>Ver Chart</strong></p>
  ...
  return (
    <div>
      <div style={{display:"flex",gap:8,marginBottom:20}}>
        {["dark","light"].map(s=>(<button key={s} onClick={()=>setCardTheme(s)} style={{padding:"9px 20px",borderRadius:8,border:`1px solid ${cardTheme===s?C.gold:C.border}`,background:cardTheme===s?C.goldBg:"none",color:cardTheme===s?C.gold:C.muted,fontFamily:"'IBM Plex Mono'",fontSize:12,fontWeight:600,cursor:"pointer"}}>{s==="dark"?"?? Oscuro":"?? Claro"}</button>))}
      </div>
