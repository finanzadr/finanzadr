              ...
              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:32 }} className="hero-grid">
                <div style={{ maxWidth:540 }} className="hero-text">
                  ...
                  <div style={{ display:"flex", gap:10, flexWrap:"wrap" }}> 
                    <button onClick={() => window.open("https://app.finanzadr.com", "_blank")} style={{ background:"#00d68f", color:"#000", border:"none", padding:"13px 26px", borderRadius:8, cursor:"pointer", fontFamily:"'IBM Plex Mono'", fontSize:12, fontWeight:800, marginBottom:10, width:"100%" }}>🚀 Entrar a la App  &rarr;</button>
